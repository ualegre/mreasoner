/* Generated By:JavaCC: Do not edit this line. ConfigsReader.java */
...
{ex.printStackTrace() ;}
  ...
  final public MConfigs readConfigs() throws ParseException {
    ...
    jj_consume_token(EXECUTION_MODE_END);
    jj_consume_token(USE_FIXED_ITERATION_TIME);
    if(readString().equals("true"))
    ...
    jj_consume_token(RESULTS_FILE_PATH);
    configs.getFilesConfigs().setResultsFilePath(readString());
    jj_consume_token(RESULTS_FILE_PATH_END);
    jj_consume_token(LFPUBS_OUTPUT_FILE_PATH);
    configs.getFilesConfigs().setLFPUBSOutputFilePath(readString());
    jj_consume_token(LFPUBS_OUTPUT_FILE_PATH_END);
    jj_consume_token(SESSION_FILE_PATH);
    configs.getFilesConfigs().setSessionFilePath(readString());
    jj_consume_token(SESSION_FILE_PATH_END);
    jj_consume_token(SSH_CONFIGS_FILE_PATH);
    configs.getFilesConfigs().setSshConfigsFilePath(readString());
    jj_consume_token(SSH_CONFIGS_FILE_PATH_END);
    jj_consume_token(DATABASE_TYPE);
    configs.getDBConfigs().setDbType(readString());
    jj_consume_token(DATABASE_TYPE_END);
    jj_consume_token(DATABASE_DRIVER);
    configs.getDBConfigs().setDriver(readString());
    jj_consume_token(DATABASE_DRIVER_END);
    jj_consume_token(DATABASE_IP);
    configs.getDBConfigs().setIp(readString());
    jj_consume_token(DATABASE_IP_END);
    jj_consume_token(DATABASE_PORT);
    configs.getDBConfigs().setPort(readString());
    jj_consume_token(DATABASE_PORT_END);
    jj_consume_token(DATABASE_USER);
    configs.getDBConfigs().setUser(readString());
    jj_consume_token(DATABASE_USER_END);
    jj_consume_token(DATABASE_PASSWORD);
    configs.getDBConfigs().setPassword(readString());
    jj_consume_token(DATABASE_PASSWORD_END);
...
{if (true) return auxiliar;}
  ...
  public ConfigsReaderTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xfff0000,0xfff0000,0x3000,0x3000,};
   }
  ...
  public ConfigsReader(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public ConfigsReader(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new ConfigsReaderTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public ConfigsReader(java.io.Reader stream) {
  ...
  public ConfigsReader(ConfigsReaderTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(ConfigsReaderTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
